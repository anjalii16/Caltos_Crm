                                    ...
                                    <div class="col">
                                        ...
                                        <div class="fv-row mb-7 fv-plugins-icon-container">
                                            <div class="fv-row mb-8"><label
                                                ...
                                                <input type="text" class="form-control" name="name" value="radhe">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        ...
                                        <div class="fv-row mb-7 fv-plugins-icon-container">
                                            <div class="fv-row mb-8"><label
                                                    ...
                                                    Name</label>
                                                <input type="text" class="form-control" name="name" value="Govind">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="fv-row mb-7 fv-plugins-icon-container">
                                            <div class="fv-row mb-8"><label
                                                    class="form-label fs-6 fw-semibold form-label mt-3">
                                                    Path</label>
                                                <input class="form-control " id="formFileSm" type="file" value="abc.txt">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
