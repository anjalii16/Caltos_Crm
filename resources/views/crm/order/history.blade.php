...
@section('content')
<div id="kt_app_content_container" class="app-container container-xxl" style="margin-top:30px;">
									...
									<div class="d-flex flex-column gap-7 gap-lg-10">
										<div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
											...
											<!--end:::Tabs-->
											<!--begin::Button-->
											<a href="/metronic8/demo1/../demo1/apps/ecommerce/sales/listing.html" class="btn btn-icon btn-light btn-sm ms-auto me-lg-n7">
														...
														<table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
															...
															<tbody class="fw-semibold text-gray-600">
																...
																<tr>
																	...
																	<td class="fw-bold text-end">15/12/2022</td>
																</tr>
																<!--end::Date-->
																			...
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="ms-5">
																						...
																						<div class="fs-7 text-muted">Delivery Date: 15/12/2022</div>
																					</div>
																					<!--end::Title-->
																				</div>
																			</td>
