    ...
    <div class="d-flex flex-column gap-7 gap-lg-10" style="margin-top:20px;">
        <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
            ...
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-lg-n2 me-auto"
                ...
                <!--begin:::Tab item-->
                <li class="nav-item" role="presentation">
                    <a class="nav-link text-active-primary pb-4"  href="{{url('orderhistory')}}"
                        aria-selected="false" tabindex="-1" role="tab">Order History</a>
                </li>
                <!--end:::Tab item-->
            </ul>
            <!--end:::Tabs-->
            ...
            <!--end::Button-->
            <!--begin::Button-->
            <a href="/metronic8/demo1/../demo1/apps/ecommerce/sales/add-order.html" class="btn btn-primary btn-sm">Add New
                Order</a>
            <!--end::Button-->
        </div>
        <!--begin::Order summary-->
                        ...
                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold text-end">14/12/2022</td>
                                </tr>
                                <!--end::Date-->
                        ...
                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold text-end">
                                        <a href="/metronic8/demo1/../demo1/apps/invoices/view/invoice-3.html"
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div class="fs-7 text-muted">Delivery Date: 14/12/2022</div>
                                                    </div>
                                                    <!--end::Title-->
                                                </div>
                                            </td>
