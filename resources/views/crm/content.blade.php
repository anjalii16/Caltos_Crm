                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-center h-100">
                                    ...
                                    <div class="col-7 ps-xl-13">
                                        ...
                                        <!--end::Title-->
                                        <!--begin::Text-->
                                        <span class="fw-semibold text-white fs-6 mb-8 d-block opacity-75">Flat
                                            cartoony and illustrations with vivid unblended purple hair
                                            lady</span>
                                        <!--end::Text-->
                                        <!--begin::Items-->
                                        <div class="d-flex align-items-center flex-wrap d-grid gap-2 mb-10 mb-xl-5 ">
                                            <!--begin::Item-->
                        ...
                        <div class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                            ...
                            <div>
                                <div _ngcontent-igv-c91="">
                                    <ngx-charts-bar-vertical-2d _ngcontent-igv-c91="" class="ng-tns-c89-0 ng-star-inserted">
                                        <ngx-charts-chart class="ng-tns-c89-0">
                                            <div class="ngx-charts-outer" style="width: 600px;"><svg class="ngx-charts"
                                                    width="500" height="200">
                                                    <g class="bar-chart chart" transform="translate(117 , 10)">

                                                        <g ngx-charts-x-axis="" class="ng-tns-c89-0 ng-star-inserted">
                                                            <g class="x axis" transform="translate(0,133)">
                                                                <g ngx-charts-x-axis-ticks="" class="ng-star-inserted">
                                                                    <g>
                                                                        <g class="tick ng-star-inserted"
                                                                            transform="translate(31,20)">
                                                                            <title>China</title><text stroke-width="0.01"
                                                                                text-anchor="middle"
                                                                        ...
                                                                        <g class="tick ng-star-inserted"
                                                                            ...
                                                                            <title>USA</title><text stroke-width="0.01"
                                                                        ...
                                                                        <g class="tick ng-star-inserted"
                                                                            ...
                                                                            <title>Norway</title><text stroke-width="0.01"
                                                                                text-anchor="middle" transform=""
                                                                                style="font-size: 12px;">
                                                                                Norway </text>
                                                                        </g>
                                                                        <g class="tick ng-star-inserted"
                                                                            ...
                                                                            <title>Japan</title><text stroke-width="0.01"
                                                                                text-anchor="middle" transform=""
                                                                                style="font-size: 12px;">
                                                                                Japan </text>
                                                                        </g>
                                                                        <g class="tick ng-star-inserted"
                                                                            ...
                                                                            <title>Germany</title><text stroke-width="0.01"
                                                                                text-anchor="middle" transform=""
                                                                                style="font-size: 12px;">
                                                                                Germany </text>
                                                                        </g>
                                                                        <g class="tick ng-star-inserted"
                                                                            ...
                                                                            <title>France</title><text stroke-width="0.01"
                                                                                text-anchor="middle" transform=""
                                                                                style="font-size: 12px;">
                                                                                France </text>
                                                                        </g>
                                                                ...
                                                                <!---->
                                                                <g ngx-charts-axis-label="" class="ng-star-inserted">
                                                                    <text stroke-width="0.01" x="184"
                                                                        y="47" text-anchor="middle"
                                                                        transform=""> Country
                                                                    </text>
                                                                </g>
                                                                <!---->
                                                        ...
                                                        <!---->
                                                        <g ngx-charts-y-axis="" class="ng-tns-c89-0 ng-star-inserted">
                                                            <g class="y axis" transform="translate(-5 , 0)">
                                                                <g ngx-charts-y-axis-ticks="" class="ng-star-inserted">
                                                                    <g>
                                                                        <g class="tick ng-star-inserted"
                                                                            transform="translate(0,128)">
                                                                            <title>0</title><text stroke-width="0.01"
                                                                                dy=".32em" x="-9"
                                                                                text-anchor="end"
                                                                ...
                                                                <!---->
                                                                <g ngx-charts-axis-label="" class="ng-star-inserted">
                                                                    <text stroke-width="0.01" x="-64"
                                                                        y="-87" text-anchor="middle"
                                                            ...
                                                            <g ngx-charts-series-vertical=""
                                                                ...
                                                                <g class="ng-tns-c88-1 ng-star-inserted" style="">
                                                                    <g ngx-charts-bar="" ngx-tooltip=""
                                                                        ...
                                                                        <!---->
                                                                        <path stroke="none" role="img"
                                                                            tabIndex="-1" class="bar"
                                                ...
                                                <ngx-charts-legend class="chart-legend ng-star-inserted">
                                                    <div style="width: 100px;">
                                                        ...
                                                        <div class="legend-wrap">
                                                            <ul class="legend-labels" style="max-height: 155px;">
                                                                <li class="legend-label ng-star-inserted">
                                                                    <ngx-charts-legend-entry><span tabindex="-1"
                                                                            title="2018"><span
                ...
                <div class="col-xxl-6 mb-5 ">
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-5">
                            <div class="card-title d-flex flex-column float-right"><a href="./dashboards/performance.html"
                ...
                <div class="card h-md-100">
                    <div class="card-header position-relative py-0 border-bottom-2"><a
                        ...
                        <ul class="nav nav-stretch nav-pills nav-pills-custom d-flex mt-4" role="tablist">
                            <li class="nav-item p-0 ms-0" role="presentation"><a data-kt-timeline-widget-4="tab"
                                    data-bs-toggle="tab" href="#kt_timeline_widget_4_tab_day"
                                    class="nav-link btn btn-color-gray-400 flex-center px-3 active" aria-selected="true"
                                    role="tab"><span class="nav-text fw-bold fs-4 mb-3">Day</span><span
                            ...
                            <li class="nav-item p-0 ms-0" role="presentation"><a data-kt-timeline-widget-4="tab"
                                    ...
                                    class="nav-link btn btn-color-gray-400 flex-center px-3" aria-selected="false"
                                    tabindex="-1" role="tab"><span
                    ...
                    <div class="card-body pb-0">
                        <div class="tab-content">
                            ...
                            <div class="table-responsive pb-10">
                                <div id="kt_timeline_widget_4_4" data-kt-timeline-widget-4-image-root="assets/media/"
                    ...
                    <div class="card card-flush h-xl-100">
                        <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px"
                            ...
                            <div class="card-toolbar pt-5"><button data-kt-menu-trigger="click"
                                    ...
                                    class="btn btn-sm btn-icon btn-active-color-primary btn-color-white bg-white bg-opacity-25 bg-hover-opacity-100 bg-hover-white bg-active-opacity-25 w-20px h-20px"><span
                                        class="svg-icon svg-icon-4"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div data-kt-menu="true"
                                    ...
                                    <div class="separator mb-3 opacity-75"></div>
                                    <div class="menu-item px-3"><a href="#" class="menu-link px-3">Click to
                                            copy
                                            English video link</a>
                                    </div>
                                    <div class="menu-item px-3"><a href="#" class="menu-link px-3">Click to
                                            copy
                                            Hindi video link</a>
                        ...
                        <div class="bg-body shadow-sm card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1"
                            ...
                            <div class="d-flex align-items-center mb-6">
                                <div class="symbol symbol-45px w-40px me-5"><span class="symbol-label bg-lighten"><span
                                            class="svg-icon svg-icon-1"><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div class="tab-pane fade show active" id="kt_upgrade_plan_startup">
                                        ...
                                        <div class="pt-1">
                                            ...
                                            <div class="d-flex align-items-center mb-7">
                                                <span class="fw-semibold fs-5 text-gray-700 flex-grow-1">Up
                                                    to 10
                                                    Active Users</span>
