        ...
        <div class="card" style="margin-top:10px;">
            ...
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-dark fs-1">Service Support</span>
                </h3>
                <div class="card-toolbar">
                    <a href="{{ url('supportticketadd') }}" class="btn btn-primary">Add Service Support</a>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0 ">
                                    ...
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_subscriptions_table"
                                        rowspan="1" colspan="1"
                                        aria-label="Created Date: activate to sort column ascending"
                                        style="width: 125px;">Mode Of Contact</th>
                                    <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_subscriptions_table"
                                        rowspan="1" colspan="1"
                                        aria-label="Created Date: activate to sort column ascending"
                                        style="width: 125px;">Mode Of Time</th>
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr class="odd">
                                    ...
                                    <!--begin::Status=-->
                                    <td>
                                        <div class="badge badge-light-success">subject</div>
                                    </td>
                                    <!--end::Status=-->
                                    <!--begin::Billing=-->
                                    <td>
                                        <div class="badge badge-light">product</div>
                                    </td>
                                    <!--end::Billing=-->
                                    <!--begin::Product=-->
                                    <td>attachements</td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ url('Supportticketview') }}" class="menu-link px-3">View</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ url('supportticketedit') }}" class="menu-link px-3">Edit</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
