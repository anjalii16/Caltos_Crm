                ...
                <div class="card-body pt-5">
                    ...
                    <div class="d-flex flex-column gap-5">
                        ...
                        <div class="d-flex flex-stack">
                            <a href="/metronic8/demo1/../demo1/apps/contacts/getting-started.html"
                    ...
                    <a href="/metronic8/demo1/../demo1/apps/contacts/add-contact.html" class="btn btn-primary w-100">
                    ...
                    <div class="scroll-y me-n5 pe-5 h-300px h-xl-auto" data-kt-scroll="true"
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <!--begin::Details-->
                                <div class="ms-4">
                                    <a href="/metronic8/demo1/../demo1/apps/contacts/view-contact.html"
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-4">
                                    <a href="/metronic8/demo1/../demo1/apps/contacts/view-contact.html"
                                        class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Mikaela Collins</a>
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-4">
                                    <a href="/metronic8/demo1/../demo1/apps/contacts/view-contact.html"
                                        class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">Francis Mitcham</a>
                    ...
                    <div class="card-toolbar gap-3">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                            ...
                            <div class="menu-item px-3">
                                <a href="/metronic8/demo1/../demo1/apps/contacts/edit-contact.html"
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link px-3" id="kt_contact_delete"
                                    data-kt-redirect="/metronic8/demo1/../demo1/apps/contacts/getting-started.html">Delete</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                        <!--end::Menu-->
                ...
                <div class="card-body pt-5">
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x fs-6 fw-semibold mt-6 mb-8"
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                                href="#kt_contact_view_meetings" aria-selected="false" tabindex="-1" role="tab">
                    ...
                    <div class="tab-content" id="">
                        ...
                        <div class="tab-pane fade" id="kt_contact_view_meetings" role="tabpanel">
                            <!--begin::Dates-->
                            <ul class="nav nav-pills d-flex flex-stack flex-nowrap hover-scroll-x" role="tablist">
                                <!--begin::Date-->
