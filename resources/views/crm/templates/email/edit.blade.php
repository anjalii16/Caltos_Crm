                ...
                <div class="card-body pt-8 px-lg-20">
                    ...
                    <form id="kt_ecommerce_settings_general_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-1 fv-plugins-icon-container">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="email" class="form-control " name="email" placeholder="20" value="">
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-1 fv-plugins-icon-container">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="email" class="form-control " name="email" placeholder="Product" value="">
                        ...
                        <div class="fv-row mb-3">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <textarea class="form-control " name="notes" placeholder="Important"></textarea>
                            <!--end::Input-->
                        </div>
                        <div class="fv-row mb-3">
                            <!--begin::Label-->
    ...
    <h3>Quick and Simple TinyMCE 5 Integration</h3>
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                            ...
                            <div class="col">
                                ...
                                <div class="fv-row mb-1 fv-plugins-icon-container">
                                    <!--begin::Label-->
                                    <label class="fs-6 text-black form-label mt-1 mb-2">
