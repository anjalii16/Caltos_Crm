...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
       ...
       `                 <span class="card-label fw-bold text-dark fs-1">Email Templates</span>
                    </h3>
                    <div class="card-toolbar">
                        <a href="{{url('emailadd')}}" class="btn btn-primary">Add Email Template</a>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr class="odd">
                                    ...
                                    <!--begin::Billing=-->
                                    <td>
                                        <div class="badge badge-light">title</div>
                                    </td>
                                    <!--end::Billing=-->
                                    <!--begin::Product=-->
                                    <td>Basic</td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ url('emailview') }}" class="menu-link px-3">View</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ url('emailedit') }}" class="menu-link px-3">Edit</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
