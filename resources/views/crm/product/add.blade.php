...
@section('content')
    <form id="kt_ecommerce_add_product_form"
        ...
        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
            ...
            <!--begin::Status-->
            <div class="card card-flush py-4" data-select2-id="select2-data-132-svul">
                <!--begin::Card header-->
                <div class="card-header">
                    <!--begin::Card title-->
                    <div class="card-title">
                ...
                <!--end::Card header-->
                <!--begin::Card body-->
                <div class="card-body pt-0" data-select2-id="select2-data-131-avpt">
                    <!--begin::Select2-->
                    <select class="form-select mb-2 select2-hidden-accessible" data-control="select2"
                        ...
                        <option data-select2-id="select2-data-134-ujsd"></option>
                        <option value="published" selected="selected" data-select2-id="select2-data-11-3zzi">Published
                        </option>
                        <option value="draft" data-select2-id="select2-data-135-t040">Draft</option>
                        <option value="scheduled" data-select2-id="select2-data-136-vopw">Scheduled</option>
                        <option value="inactive" data-select2-id="select2-data-137-btlp">Inactive</option>
                    </select><span class="select2 select2-container select2-container--bootstrap5 select2-container--above"
                        dir="ltr" data-select2-id="select2-data-10-hqw9" style="width: 100%;"><span
                            class="selection"><span class="select2-selection select2-selection--single form-select mb-2"
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <select class="form-select mb-2 select2-hidden-accessible" data-control="select2"
                        ...
                        data-select2-id="select2-data-12-e62k" tabindex="-1" aria-hidden="true"
                        ...
                        data-select2-id="select2-data-13-k3k4" style="width: 100%;"><span class="selection"><span
                                ...
                                <ul class="select2-selection__rendered" id="select2-zdkm-container"></ul><span
                                    ...
                                    <textarea class="select2-search__field" type="search" tabindex="0" autocorrect="off" autocapitalize="none"
                                        ...
                                        aria-describedby="select2-zdkm-container" placeholder="Select an option" style="width: 100%;"></textarea>
                                </span>
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <select class="form-select mb-2 select2-hidden-accessible" data-control="select2"
                        ...
                        aria-hidden="true" data-kt-initialized="1">
                        <option></option>
                        <option value="default" selected="selected" data-select2-id="select2-data-15-zpw1">Default
                            template</option>
                        <option value="electronics">Electronics</option>
                        <option value="office">Office stationary</option>
                        <option value="fashion">Fashion</option>
                    </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr"
                        data-select2-id="select2-data-14-gbzd" style="width: 100%;"><span class="selection"><span
                                ...
                                <div class="d-flex flex-wrap gap-5">
                                    ...
                                    <div class="fv-row w-100 flex-md-root fv-plugins-icon-container">
                                        ...
                                        <select class="form-select mb-2 select2-hidden-accessible" name="tax"
                                            ...
                                            data-placeholder="Select an option" data-select2-id="select2-data-16-dmgi"
                                            tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                                            <option data-select2-id="select2-data-18-aq3t"></option>
                                            <option value="0">Tax Free</option>
                                            <option value="1">Taxable Goods</option>
                                            <option value="2">Downloadable Product</option>
                                        </select><span class="select2 select2-container select2-container--bootstrap5"
                                            dir="ltr" data-select2-id="select2-data-17-70xa"
                                            style="width: 100%;"><span class="selection"><span
                                                    class="select2-selection select2-selection--single form-select mb-2"
                                                    role="combobox" aria-haspopup="true" aria-expanded="false"
                                                    tabindex="0" aria-disabled="false"
                                                    aria-labelledby="select2-tax-u6-container"
                                                    aria-controls="select2-tax-u6-container"><span
                                                        class="select2-selection__rendered" id="select2-tax-u6-container"
                                                ...
                                                <div data-repeater-item=""
                                                    ...
                                                    <div class="w-100 w-md-200px">
                                                        <select class="form-select select2-hidden-accessible"
                                                            ...
                                                            data-select2-id="select2-data-127-a2d5" tabindex="-1"
                                                            aria-hidden="true">
                                                            <option data-select2-id="select2-data-129-w18a"></option>
                                                            ...
                                                            dir="ltr" data-select2-id="select2-data-128-b91m"
                                                            style="width: 100%;"><span class="selection"><span
                                                                    class="select2-selection select2-selection--single form-select"
                                                                    role="combobox" aria-haspopup="true"
                                                                    aria-expanded="false" tabindex="0"
                                                                    aria-disabled="false"
                                                                    aria-labelledby="select2-kt_ecommerce_add_product_options0product_option-ws-container"
                                                                    aria-controls="select2-kt_ecommerce_add_product_options0product_option-ws-container"><span
                                                                        class="select2-selection__rendered"
                                                                        id="select2-kt_ecommerce_add_product_options0product_option-ws-container"
                                                                        role="textbox" aria-readonly="true"
...
@section('toolbar')
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Product Form
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
                        ...
                        <div class="mb-10">
                            ...
                            <div>
                                <select class="form-select form-select-solid select2-hidden-accessible"
                                    ...
                                    data-dropdown-parent="#kt_menu_63a6cfd2191a3" data-allow-clear="true"
                                    data-select2-id="select2-data-7-pi0v" tabindex="-1" aria-hidden="true"
                                    data-kt-initialized="1">
                                    <option data-select2-id="select2-data-9-d9fa"></option>
                                    <option value="1">Approved</option>
                                    <option value="2">Pending</option>
                                    <option value="2">In Process</option>
                                    <option value="2">Rejected</option>
                                </select><span class="select2 select2-container select2-container--bootstrap5"
                                    dir="ltr" data-select2-id="select2-data-8-vjij" style="width: 100%;"><span
                                        class="selection"><span
                                            class="select2-selection select2-selection--single form-select form-select-solid"
                                            role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                            aria-disabled="false" aria-labelledby="select2-dpw4-container"
                                            aria-controls="select2-dpw4-container"><span
                                                class="select2-selection__rendered" id="select2-dpw4-container"
